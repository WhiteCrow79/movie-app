  ...
  methods: {
    async getMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/movie/now_playing?api_key=a5089f3f971ef2a7d3ac1015ed2b7214&language=en-US&page=1`
      )
    ...
    async searchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=a5089f3f971ef2a7d3ac1015ed2b7214&language=en-US&page=1&query=${this.searchInput}`
      )
      const result = await data
      result.data.results.forEach((movie) => {
